...
-Se você também está trilhando o caminho do Java ou tem interesse em alguma dessas tecnologias, sinta-se à vontade para:

-Explorar os diretórios e usar os códigos como referência.

-Sugerir melhorias ou me dar um feedback sobre as implementações.
